...
KIND_CLUSTER ?= kube-assist-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name kube-assist-builder
	$(CONTAINER_TOOL) buildx use kube-assist-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm kube-assist-builder
	rm Dockerfile.cross
